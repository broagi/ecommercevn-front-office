export const ProductCategoriies = () => {
  return <div className="grid xs:grid-cols-1 sm:grid-cols-2 gap-4 py-5">
<div className="relative group flex justify-center items-center h-48 overflow-hidden w-full">
          <img className="object-center object-cover w-full" src="https://i.ibb.co/ThPFmzv/omid-armin-m-VSb6-PFk-VXw-unsplash-1-1.png" alt="girl-image" />
        ...
        </div><div className="relative group flex justify-center items-center h-48 overflow-hidden w-full">

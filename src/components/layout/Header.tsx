...
export const Header = () => {
  ...
  <div hidden className="relative z-40 lg:hidden" role="dialog" aria-modal="true">
  ...
  <header className="relative z-50" style={{background: 'linear-gradient(5deg, rgba(255,255,0,1) 0%, rgba(250,208,44,1) 100%)'}}>
            ...
            <Link href="/products" className="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Products</Link>
              <div className="flex">
                <div className="relative flex">
                  <button type="button" className="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">Categories</button>
                </div>
                </div>
